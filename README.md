...
***Bảng Mô tả các khoảng giá trị làm khuyết***
...
***Cơ chế hoạt động thuật toán MICE***
...
***Bảng độ đo của các phương pháp điền khuyết dữ liệu***
...
***Lược đồ thể hiện cách biến đổi dữ liệu và chia tập huấn luyện – kiểm thử***

![SliptData](https://github.com/Moon2909/TimeSeriesForecasting/blob/main/Picture/SliptData.png)
...
***Độ đo RMSE của mô hình LSTM dự đoán lượng xe trong tháng 12/2020 tại các trạm giao thông với các độ trễ khác nhau.***
